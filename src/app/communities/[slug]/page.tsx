...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  return {
    ...
    description: community.description ?? `Discover ${community.name} on NOXA Communities.`,
    alternates: {
      canonical: `https://noxastreetapp.com/communities/${community.slug}`,
      languages: {
...
export default async function CommunityPage({ params }: PageProps) {
  const { slug } = await params;
  return <CommunityProfile locale="en" slug={slug} />;
}
