        ...
        <div className={styles.shell}>
          <form className={styles.toolbar} method="get">
            <div className={styles.searchGroup}>
              ...
              <input id="community-search" className={styles.searchInput} name="q" defaultValue={query} placeholder={t.searchPlaceholder} type="search" />
          ...
          {filtered.length ? <div className={styles.grid}>{filtered.map((community) => {
            ...
            return <Link className={styles.card} href={href} key={community.id}>
              ...
              <div className={styles.cardBody}>
                <div className={styles.cardTop}><h2>{community.name}</h2>{community.verified ? <span className={styles.verified}>VERIFIED</span> : null}</div>
